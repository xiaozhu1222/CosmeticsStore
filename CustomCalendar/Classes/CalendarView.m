...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        _dayWidth                   = [UIScreen mainScreen].bounds.size.width/8;
        _originX                    = ([UIScreen mainScreen].bounds.size.width - 8*_dayWidth)/2;
        ...
        _dayBgColorSelected         = [UIColor blueColor];
...
-(id)init
{
    self = [self initWithFrame:CGRectMake(0, 0, main_w, main_h)];
    if (self)
    {
